...
class GameOfLife:
    ...
    def __seed(self):
        ...
        seed  = np.random.random_sample([x-2 for x in shape]) < (self.__settings.seed_liveness_probability / 2)
        seed2 = np.random.random_sample([x-2 for x in shape]) < (self.__settings.seed_liveness_probability / 2)
